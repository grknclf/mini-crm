...
module.exports = {
  ...
  async down(queryInterface) {
    try { await queryInterface.removeIndex('app_logs', 'ix_app_logs_trace_id'); } catch (e) {}
    try { await queryInterface.removeIndex('app_logs', 'ix_app_logs_created_at'); } catch (e) {}
